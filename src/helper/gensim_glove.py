...
path = '/mnt/Data/zero_shot_reg/gloVe/'
...
def prepend_line(infile, outfile, line):
    ...
    """
    with open(path + infile, 'r') as old:
...
def prepend_slow(infile, outfile, line):
    ...
    """
    with open(path + infile, 'r') as fin:
...
print model.most_similar(positive=["salsa", "water", "white", "coffee"], negative=[], topn=4)
